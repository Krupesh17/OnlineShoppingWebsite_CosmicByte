...
<body>
    	...
    	<div class="product-nav-bar">
    		<div class="drop-down-categories">
                ...
                <div class="categories-drop-down-content" id="categories-drop-down">
                    <a href="${pageContext.request.contextPath}/product/cAccessoryType/Laptop Cooling Pad">Laptop Cooling Pad</a>
                    <a href="${pageContext.request.contextPath}/product/cAccessoryType/Adapter And Cabel">Adapters and Cables</a>
                    <a href="${pageContext.request.contextPath}/product/computer_accessories" id="l-all"><span>List All Products</span><span>&#10140;</span></a>
                </div>
    		</div>
    		...
    		<div class="drop-down-sortBy"> 
                ...
                <div class="sortBy-drop-down-content" id="sortBy-drop-down">
                    <a href="${pageContext.request.contextPath}/product/computer_accessories">Default</a>
                    <a href="${pageContext.request.contextPath}/product/cAccessoryType/lowtohigh">Price (Low to High)</a>
                    <a href="${pageContext.request.contextPath}/product/cAccessoryType/hightolow">Price (High to Low)</a>
                </div>
    		</div>
    	</div>
    	
    	<div class="product-nav-sub-bar">
    		<form action="${pageContext.request.contextPath}/product/search/c-accessory" method="get" class="search-field">
	...
	<script type="text/javascript">
    	let linkComputerAccessory = document.getElementById('link-c-accessory');
    	linkComputerAccessory.style.color = "#e9a825";
    </script>
    ...
    <script type="text/javascript">
	    ...
	    const searchBarDropDown = document.getElementById('search-bar-drop-down');
	    const searchBarOpenBtn = document.getElementById('product-search-bar');
	    const dropdownArrow3 = document.getElementById('dropdown-3-arrow');
	    ...
	    searchBarOpenBtn.addEventListener('click', (e)=> {
	    	...
	    	if(searchBarDropDown.classList.contains('show')) {
	    		dropdownArrow3.innerText = 'expand_less';
	    		searchBarOpenBtn.style.backgroundColor = '#e09616';
	        }
	        else {
	        	dropdownArrow3.innerText = 'expand_more';
	        	searchBarOpenBtn.style.backgroundColor = '#fba819';
	        }
	    });
