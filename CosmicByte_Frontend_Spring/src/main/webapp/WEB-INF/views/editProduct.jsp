...
<body>
	...
	<div class="container">
        ...
        <sp:form action="${pageContext.request.contextPath}/product/update" method="post" modelAttribute="editProduct" class="add-product-form">

		<div class="top-bar">
            <h3>Edit Product</h3>
            <div class="btn-group">
                <input type="submit" id="btn-add-product" value="Update Product">
            ...
            <div class="flex-box">
                <div class="inner-box-left">
                    ...
                    <sp:input path="prodId" type="text" name="productId" readonly="true" placeholder="Product ID"/>
                </div>
            ...
            <div class="flex-box">
                ...
                <div class="inner-box-right">
                    ...
                    <sp:select path="prodOnSale" name="productOnSale" class="selecter">
                    	<option>true</option>
                    	<option>false</option>
                    </sp:select>
            ...
            <div class="btn-group-2">
                <input type="submit" value="Update Product" id="btn-add-product-block">
            </div>
