...
<body>
    ...
    <section class="container">
    	...
    	<div class="product-nav-bar">
    		<div class="drop-down-categories">
                ...
                <div class="categories-drop-down-content" id="categories-drop-down">
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/Gaming Keyboard">Gaming Keyboard</a>
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/Gaming Mouse">Gaming Mouse</a>
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/Gaming Keyboard And Mouse Combo">Gaming Keyboard and Gaming Mouse Combo</a>
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/Gamepad">Gamepads</a>
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/Mousepad">Mousepads</a>
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/Gaming Chair">Gaming Chairs</a>
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/Gaming Desk">Gaming Desks</a>
                    <a href="${pageContext.request.contextPath}/product/gaming_accessories" id="l-all"><span>List All Products</span><span>&#10140;</span></a>
                  </div>
    		</div>
    		
    		<div class="drop-down-sortBy"> 
                <button class="drop-btn-sortBy" id="dropdown-btn-sortBy"><b id="selected-option">Sort By</b> <span id="dropdown-2-arrow" class="material-symbols-outlined">expand_more</span></button></button>
                <div class="sortBy-drop-down-content" id="sortBy-drop-down">
                    <a href="${pageContext.request.contextPath}/product/gaming_accessories">Default</a>
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/lowtohigh">Price (Low to High)</a>
                    <a href="${pageContext.request.contextPath}/product/gAccessoryType/hightolow">Price (High to Low)</a>
                </div>
    		</div>
    	</div>
    	
    	<div class="product-nav-sub-bar">
    		<form action="${pageContext.request.contextPath}/product/search/g-accessory" method="get" class="search-field">
    	...
    	<!-- Empty Product Container Start -->
    	<c:if test="${empty products}">
    		<div class="no-products">
    			<h4>Sorry no products available...!</h4>
    		</div>
    	</c:if>
    	<!-- Empty Product Container End -->
    ...
    <script type="text/javascript">
    	let linkGamingAccessory = document.getElementById('link-g-accessory');
    	linkGamingAccessory.style.color = "#e9a825";
    </script>
